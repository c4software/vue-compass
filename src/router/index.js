...
const routes = [{ path: "/", component: httpVueLoader("/src/views/home.vue") }, { path: "/compass", component: httpVueLoader("/src/views/compass.vue") }, { path: "/speed", component: httpVueLoader("/src/views/speedometer.vue") }];
